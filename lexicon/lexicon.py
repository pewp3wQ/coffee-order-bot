LEXICON_RU: dict[str, str | dict] = {
    "/start": "Я бот Service Coffee, готовы сделать заказ ?",

    "description": "Привет! Я бот кофейни Service Coffee. Здесь вы можете выбрать напиток и оформить заказ, а я передам ваш заказ нашим бариста.",
    ...
    "inline_kb_text": {
        ...
        'wait_time': 'Через сколько вас ждать?',
